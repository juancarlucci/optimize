...
var resizePizzas = function(size) {
	...
	function changePizzaSizes(size) {
		...
		//took out DX as per class video, minute 2:40 (https://www.udacity.com/course/viewer#!/c-ud860/l-4147498575/e-4154208580/m-4240308553)
...
//tried adding a RAF here, did not improve render times
function updatePositions() {
	...
	// Added RAF to optimize even more. Down to about 0.03 ms Average time to generate last 10 frames. Wow! 10X faster than without. From  http://wilsonpage.co.uk/preventing-layout-thrashing.
	// also note, this is much faster with .basic left, than with the optimized translateX!
	...
	// here is the optimized version w/o RAF, its about 0.23 ms Average time to generate last 10 frames
	//  for(var i = 0; i < items.length; i++) {
	// 	 var phase = Math.sin(docBodyScroll + (i % 5));
	// 	//  items[i].style.left = items[i].basicLeft + 100 * phase + 'px';
	// // 	//using translate to reduce css painting, as per https://www.paulirish.com/2012/why-moving-elements-with-translate-is-better-than-posabs-topleft/ and  https://discussions.udacity.com/t/translatex-property/19430
	// 	 items[i].style.transform = 'translateX(phase +100px)';
	//  }
...
document.addEventListener('DOMContentLoaded', function() {
	var cols = 8;
	var s = 256;
	// changed querySelector("#movingPizzas1") to get elementById, and moved it our to the loop
